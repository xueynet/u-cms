	...
	<view class="home">
		<tn-custom bg-color="bg-white">
			<block slot="left">
				...
				<navigator class='padding-left-xs' url="/pages/index/index" hover-class="none">
					<view class="cu-avatar round shadow " :style="'background-image:url(../static/logo.png);'"></view>
				</navigator>
			</block>
			<block slot="content">
				<text class="text-xxl text-black" :style="'opacity:' +  (1 - titleOpacity) + ';'">雪印网络</text>
			</block>
			<block slot="right">
        ...
        <swiper-item v-for="(item, index) in bannerArr" :key="index" class="radius-index">
          <image class='' :src="item.image.prefix" mode='aspectFill'></image>
			...
			<swiper class="swiper" :indicator-dots="true" :autoplay="true" :interval="5000" :duration="500">
				...
				<swiper-item>
					<view class="radius-index">
						<image class='' src="../../static/images/banner/banner2.jpg" mode='aspectFill'></image>
					</view>
				</swiper-item>
				<swiper-item>
					<view class="radius-index">
						<image class='' src="../../static/images/banner/banner3.jpg" mode='aspectFill'></image>
					</view>
				</swiper-item>
				<swiper-item>
					<view class="radius-index">
						<image class='' src="../../static/images/banner/banner4.jpg" mode='aspectFill'></image>
					</view>
				</swiper-item>
			</swiper>
		</view>
		...
		<view class="cu-bar bg-white margin-top-xl">
			<view class='action'>
				<text class='text-bold text-title text-xxl'>项目案例</text>
			</view>
				...
				<view class="flex">
					...
					<view class='flex-sub radius margin-right-xs margin-left-sm'>
						<view v-if="newestCase[1]" @click="navCaseDetail(newestCase[1].id)"
							...
							:style="'height:150rpx;background-image:url(' + newestCase[1].main_image.prefix + ')'">
						</view>
						<view v-if="newestCase[2]" @click="navCaseDetail(newestCase[2].id)"
							...
							:style="'height:150rpx;background-image:url(' + newestCase[2].main_image.prefix + ')'">
						</view>
					</view> -->
					<view @click="navCaseDetail(newestCase[0].id)"
						class='flex-twice bg-white margin-xs bg-img shadow-blur radius-index solid'
						style="height:330rpx;background-image:url(../../static/images/case/case1.jpg)">
					</view>
					<view class='flex-sub radius margin-right-xs margin-left-sm'>
						<view @click="navCaseDetail(newestCase[1].id)"
							class='flex-sub bg-white margin-top-xs bg-img shadow-blur radius-index solid'
							style="height:150rpx;background-image:url(../../static/images/case/case2.jpg)">
						</view>
						<view @click="navCaseDetail(newestCase[2].id)"
							class='flex-sub bg-white margin-top bg-img shadow-blur radius-index solid'
							style="height:150rpx;background-image:url(../../static/images/case/case3.jpg)">
						</view>
					</view>
				</view>
			</view>
		...
		<view class='nav-list margin-top'>
			<view class="nav-li bg-index1" @click="navBusinessDetail">
				<view class="nav-title">雪印</view>
