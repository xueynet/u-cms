<template>
	<view class="case">
		...
		<scroll-view v-if="showNavScroll" scroll-x class="bg-white nav shadow fixed" scroll-with-animation
				...
				categoryData: [
					{
						id:'001',
						title:'择音APP！',
						imgUrl:'../../static/images/anli/anli1.jpg'
					},{
						id:'002',
						title:'我会叫他们好受的！',
						imgUrl:'../../static/images/anli/anli2.jpg'
					},{
						id:'003',
						title:'我的能量，无穷无尽。',
						imgUrl:'../../static/images/anli/anli3.jpg'
					},
				], // 案例栏目数据
